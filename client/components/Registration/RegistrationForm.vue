	...
	<form @submit.prevent="submit">
		<fieldset>
			<section>
				...
				<p>
					赤羽台祭では、感染症対策とINIAD生の生活を体験することを目的とした企画として、普段INIAD生が構内で着用しているネームカードを全員にご着用いただきます。ご着用いただくカードについては、大学祭特別仕様のデザインを複数種類ご用意いたしましたので、お好きなものをお選びください。また、事前登録をいただいた方にのみ、特別にご登録いただいたニックネームを印刷したネームカードをご用意いたしますので、ご来場をご予定の方はぜひこのままご登録をお進めください。
				</p>
				<label>
